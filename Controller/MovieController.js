...
const startUploadChunk = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ error: "An error occurred while starting the upload." });
  }
};
...
const uploadSingleChunkOneByOne = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ error: "An error occurred while uploading the part." });
  }
};
...
const completeUploadAndAssembleChunk = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ error: "An error occurred while completing the upload." });
  }
};
...
//     res
//       .status(500)
//       .json({ error: "An error occurred while deleting the resource.", error });
//   }
// };
...
module.exports = {
  ...
  getAllMovie,
  startUploadChunk,
  uploadSingleChunkOneByOne,
  completeUploadAndAssembleChunk,
